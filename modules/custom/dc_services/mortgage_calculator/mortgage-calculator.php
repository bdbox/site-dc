...
$down = floatval(preg_replace("/[^0-9.]*/","",$_POST["down"]));
$principal = $price * (1 - $down/100);
$length = floatval(preg_replace("/[^0-9.]*/","",$_POST["length"])) * 12;
...
"<tr class='hd'><th></th><th>Amount</th></tr>".
"<tr class='odd'><td class='lt' width='160'>Price</td><td> $".number_format($price,2,'.',',')."</td></tr>".
"<tr class='even'><td class='lt'>Down</td><td>" . $down . "%</td></tr>".
"<tr class='odd'><td class='lt'>Principal</td><td>$" . number_format($principal,2,'.',','). "</td></tr>".
...
for ($i=1; $i<=$length/12; $i++){
	...
	$output .= "<table class='mortgageTableOuter'><tr><td><table class='mortgageTable' width='100%' border='0' cellspacing='0'>";
