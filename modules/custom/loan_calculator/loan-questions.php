...
<title>loan Questions</title>
<meta name="description" content="questions asked about loan.">
...
<script src="../js/jquery-1.7.2.min.js" type="text/javascript"></script>
  <script type='text/javascript'>
    ...
    function top_stories(o){
      ...
      var output = '<h1>Questions Asked About loan</h1>';
...
<body>
    <div id="page">
        ...
        <div style="margin-left:40px;margin-top:10px;"><a href="loan.php">Back to loan calculator</a></div>
        		
        	  <div id="questions"></div>
  				<script src='http://answers.yahooapis.com/AnswersService/V1/questionSearch?appid=uWBEQALIkY03D9ULJRrPqt2HF7S6Fv3Jf7v6&query=loan&output=json&callback=top_stories'>
  				</script> 
