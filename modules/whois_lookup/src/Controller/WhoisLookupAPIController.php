...
namespace Drupal\whois_lookup\Controller;
 ...
 */
class WhoisLookupAPIController extends ControllerBase {
  ...
  public function get_example( Request $request ) {
   ...
   // return new JsonResponse( $response );
    ...
    if (isset($domain)){
      echo new JsonResponse($this->makeClickableLinks(nl2br($this->whois_query("www.google.com"))));
    } else {
    	echo "";
    }
  }
