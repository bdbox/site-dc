    ...
    $(document).ready(function () {
        ...
        $("#calculateBtn").bind("click", function () {
            ...
            if ($('#addToCompare').is(':checked')) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/sites/all/modules/dc-services/mortgage-calculator/mortgage-calculator.php",
                    data: dataString,
        ...
        $("#calculateBtn2").bind("click", function () {
            ...
            $.ajax({
                type: "POST",
                url: "/sites/all/modules/dc-services/mortgage-calculator/mortgage-calculator2.php",
                data: dataString_1,
                success: function (response) {
                    $('#result_panel').html(response);
                }
