...
function calculate(){ 
	...
	for (i =0; i <= 3; i ++){
		...
		//conception
		dates.push(addDays(tempLmp, (14 + cycles - 28)));
		tips.push("Estimated conception date");
		colors.push("highlight-2");
	}
	
		
	//
	var conception = addDays(lmp, (14 + cycles - 28));
	reportStr += "Estimated conception date is  " + conception.toDateString() + ".<br />";

	$("#txtAnswer").val( conception.toDateString());
	doReport(lmp);
}
