...
var Animals=new Array("Rat","Ox","Tiger","Rabbit","Dragon","Snake","Horse","Goat","Monkey","Rooster","Dog","Pig");
var solarTerm = new Array("小寒","大寒","立春","雨水","惊蛰","春分","清明","谷雨","立夏","小满","芒种","夏至","小暑","大暑","立秋","处暑","白露","秋分","寒露","霜降","立冬","小雪","大雪","冬至");
var sTermInfo = new Array(0,21208,42467,63836,85337,107014,128867,150921,173149,195551,218072,240693,263343,285989,308563,331033,353350,375494,397447,419210,440795,462224,483532,504758);
var nStr1 = new Array('日','一','二','三','四','五','六','七','八','九','十');
var eStr1 = new Array('Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday');
...
//============================== 阴历属性
function calElement(sYear,sMonth,sDay,week,lYear,lMonth,lDay,isLeap,cYear,cMonth,cDay, nweek) {
...
var cY, cM, cD, nW; //年柱,月柱,日柱, week of year
...
//cYear,cMonth,cDay
this[i] = new calElement(y, m+1, i+1, eStr1[(i+this.firstWeek)%7],
lY, lM, lD++, lL,
cY ,cM, cD, nW );
}
...
document.getElementById("GZ").innerHTML = '<span class="gznl"> (Year of '+Animals[(SY-4)%12]+')</span>';

document.getElementById("dtBackground").innerHTML = SY + "<br />" + monthName[SM];
...
festival = '<div class="festival">' + cld[d].solarFestival + ' ' + cld[d].lunarFestival+'</div>';
var hltxt='';
if(cld[d].sYear == 2008){
...
s= '<div class="topic">' +
'<div class="disp"><span class="l1">'+

//cld[d].sYear+'年'+cld[d].sMonth+'月'+cld[d].sDay+'日 <br />星期'+cld[d].week+'</span><span class="l2">'+ +cld[d].sDay+ '</span>' + 
//'<span class="l3">农历'+(cld[d].isLeap?'闰 ':' ')+cld[d].lMonth+'月'+cld[d].lDay+'日</span><br />'+
//'<span class="l4">'+cld[d].cYear+'年 '+cld[d].cMonth+'月 '+cld[d].cDay +'日</span>'+hltxt+


cld[d].sMonth+'/'+cld[d].sDay+'/' + cld[d].sYear + '<br />'+cld[d].week+'</span><span class="l2">'+ +cld[d].sDay+ '</span>' + 



'</div>'+ festival +'</div>';
//console.log(cld[d]);
document.getElementById("theDay").innerHTML = s;
...
var tdv;
function init() {
   dStyle = document.getElementById("theDay").style;
   document.getElementById("CLD").SY.selectedIndex=tY-1900;
   document.getElementById("CLD").SM.selectedIndex=tM;
   drawCld(tY,tM);
   showD(tdv);
